...
export default function buildTestSuite(
  ...
  describe(TimesheetRouter.name, function() {
    ...
    it("should have GET /byUserId/:id", function(done) {
      agent
        .get(baseUrl + "/byUserId/1")
        .set("Accept", "application/json")
        .send()
        .expect(500, /Method not implemented/, function(error: any) {
          if (error) throw error;
    ...
    it("should have GET /populated/:id", function(done) {
      agent
        .get(baseUrl + "/populated/1")
        .set("Accept", "application/json")
        .send()
        .expect(500, /Method not implemented/, function(error: any) {
          if (error) throw error;
